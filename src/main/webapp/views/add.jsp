...
<body>
	<nav>
		<ul>
			...
			<li>
				<a href="/junkdetails"><i class="fa fa-user "></i> DOCTORS</a>
			</li>
			<li>
...
<input type="text" name="field2" placeholder="Email id *">
<input type="text" name="field3" placeholder="Description *">
...
<fieldset>
<legend><span class="number">2</span> Upload proof</legend>
